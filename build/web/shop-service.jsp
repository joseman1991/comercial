            ...
            <div id="core">
                ...
                <div id="page-header">
                    <div class="container">
                        ...
                        <s:if test="#reserva==null">
                            <h2 class="h2">No hay reservación registrada en esta sessión</h2>
                        </s:if>
                        <s:else>
                            <h2 class="h2">Reserva para el <s:property value="#reserva.fechahora"/></h2>
                        </s:else>
                                        ...
                                        <s:iterator value="listaItems" var="list">
                                            <tr>
                                                <s:if test="item.idtipo==2" >                                                        
                                                    ...
                                                    <td>
                                                        <div class="col-xs-4">
                                                            <input type="text" class="col-xs-4" value='<s:property value="cantidad"/>' max="4" readonly="">
                                                        </div>
                                                    </td>
                                ...
                                <div class="cart-tools">
                                    ...
                                    <s:if test="#reserva!=null">
                                        <div class="cart-buttons">                                        
                                            <button class="c-button" type="submit">Confirmar reservación</button>
                                        </div>
                                    </s:if>
