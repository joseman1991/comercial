							...
							<ul>
								...
								<li class="m-active">
									...
									<ul class="sub-menu">
										...
										<li class="m-active"><a href="blog-image-disqus.jsp">Disqus Comments</a></li>
									</ul>
								</li>
								<li>
							...
							<div id="page-content">
								...
								<div class="blog-detail">
									...
									<div class="article-comments">
										...
										<h2 class="heading-2 m-small">Comments</h2>

										<!-- DISQUS CODE : begin -->
										<div id="disqus_thread"></div>
										<script type="text/javascript">
											var disqus_shortname = 'lv-themes'; // required: replace example with your forum shortname
