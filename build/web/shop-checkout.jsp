							...
							<ul>
								...
								<li class="m-active">
									...
									<ul class="sub-menu">
										...
										<li class="m-active"><a href="shop-checkout.jsp">Checkout</a></li>
									</ul>
								</li>
								<li>
				...
				<div class="container">
					...
					<div id="page-content">
						...
						<div class="shop-checkout">
							...
							<form class="default-form m-validate" action="shop-checkout.jsp">
									...
									<div class="col-sm-6">
										...
										<div class="billing-address">
											...
											<div class="row">
												<div class="col-sm-6">
													...
													<div class="form-field">
														...
														<input type="text" class="m-required" id="checkout-first-name">
													</div>
												...
												<div class="col-sm-6">
													...
													<div class="form-field">
														...
														<input type="text" id="checkout-last-name">
													</div>
													<!-- LAST NAME FIELD : end -->
											...
											<div class="form-field">
												...
												<input type="text" id="checkout-company">
											</div>
											<!-- COMPANY FIELD : end -->
											...
											<div class="form-field">
												...
												<input type="text" class="required" id="checkout-address">
											</div>
											<!-- ADDRESS FIELD : end -->
											...
											<div class="form-field">
												...
												<input type="text" class="m-required" id="checkout-city">
											</div>
											<!-- CITY FIELD : end -->
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<div class="form-field">
														...
														<input type="text" id="checkout-postcode">
													</div>
													<!-- POSTCODE FIELD : end -->
											...
											<div class="row">
												<div class="col-sm-6">
													...
													<div class="form-field">
														...
														<input type="text" class="m-required m-email" id="checkout-email">
													</div>
													<!-- EMAIL FIELD : end -->
											...
											<div class="shipping-address-fields" style="display: none;">
												...
												<div class="row">
													...
													<div class="col-sm-6">
														...
														<!-- POSTCODE FIELD : begin -->
														<div class="form-field">
															<label for="checkout-postcode-shipping">Postcode</label>
															<input type="text" id="checkout-postcode-shipping">
														</div>
														<!-- POSTCODE FIELD : end -->
										...
										<div class="payment-methods">
											...
											<ul class="c-accordion m-radio-group">
												<li class="m-active">
													...
													<label for="payment-method-1" class="accordion-title">Direct Bank Transfer</label>
												...
												<li>
													<input type="radio" id="payment-method-2" name="payment-method" value="cheque">
													<label for="payment-method-2" class="accordion-title">Cheque Payment</label>
													<div class="accordion-content">
									...
									<div class="col-md-6">
										...
										<div class="order-summary">
											...
											<table>
												...
												<tbody>
													<tr>
														<td>Almond Supple Skin Oil × 1</td>
														<td>$35.40</td>
													</tr>
													<tr>
														<td>Almond Tonic Body Oil × 1</td>
														<td>36.50</td>
													</tr>
													<tr>
														<td>Aroma Volumizing Mask × 1</td>
														<td>€27.20</td>
													</tr>
												</tbody>
											</table>
								...
								<div class="checkout-footer">
									<a href="shop-cart.jsp" class="c-button m-type-2 back-btn">Back To Cart</a>
									<button class="c-button submit-btn" type="submit">Place Order</button>
								</div>
								<!-- CHECKOUT FOOTER : end -->
