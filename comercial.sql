...
insert into usuarios values('abigail','123','Abigail','Selena','Cedeño','Chaves','abicedcha@gmail.com','client_01.jpg','BABAHOYO','1234567890');
insert into usuarios values('maria','123','Maria','Fernanda','Vera','Mejia','mariavera@live.com','client_02.jpg','LA ISLA','0123456789');
...
-------------------------------------
insert into items values(default,'Azúcar','Algo','Algo2',1.5,0,1,1,'azucar.jpg',5);
insert into items values(default,'Sal','Algo','Algo2',0.6,15.07,1,1,'sal.jpg',5);
insert into items values(default,'Fideo','Algo','Algo2',.5,11.54,1,1,'fideo.jpg',5);
insert into items values(default,'Cocoa','Algo','Algo2',.75,11.54,1,1,'cocaa1.jpg',5);
insert into items values(default,'Chocolate','Algo','Algo2',1.25,11.54,1,1,'cocoa.jpg',5);
insert into items values(default,'Café','Algo','Algo2',0.35,11.54,1,1,'cafe.png',5);
insert into items values(default,'Licor de café','Algo','Algo2',26,11.54,1,1,'licor_cafe.jpg',5);
insert into items values(default,'Amaretto','Algo','Algo2',11,11.54,1,1,'licor de cacao.jpg',5);
insert into items values(default,'Licor de cacao','Algo','Algo2',5.5,11.54,1,1,'amareto.jpg',5);
insert into items values(default,'Jhonny Rojo','Algo','Algo2',60,11.54,1,1,'jhonny rojo.jpg',5);
insert into items values(default,'Jhonny Azul','Algo','Algo2',450,11.54,1,1,'jhonny azul.jpg',5);
insert into items values(default,'Jhonny Negro','Algo','Algo2',150,11.54,1,1,'jhonny negro.jpg',5);
insert into items values(default,'Jhonny verde','Algo','Algo2',500,11.54,1,1,'Jhonny verde.jpg',0);
insert into items values(default,'Brandy','Algo','Algo2',15,11.54,1,1,'brandy.jpg',5);
